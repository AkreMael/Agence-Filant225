              ...
              <div className="flex items-center justify-between mt-1 pt-3 border-t border-gray-50">
                ...
                <div className="flex gap-2.5">
                  ...
                  <a 
                    ...
                    onClick={() => {
                      databaseService.logActivity(user, 'assistant_qr_call_company', { phone: COMPANY_PHONE }).catch(console.error);
                    }}
                    className="p-2.5 bg-blue-600 text-white rounded-full shadow-lg active:scale-90 transition-transform flex items-center justify-center"
                  >
                  ...
                  <a 
                    ...
                    onClick={() => {
                        databaseService.logActivity(user, 'assistant_qr_whatsapp_company', { 
                            contactName: contact.name,
                            contactPhone: contact.phone
                        }).catch(console.error);
                    }}
                    className="p-2.5 bg-[#25D366] text-white rounded-full shadow-lg active:scale-90 transition-transform flex items-center justify-center"
                  >
