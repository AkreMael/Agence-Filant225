...
import { History as LucideHistory, Calendar as LucideCalendar, Star as LucideStar, MessageSquare as LucideMessageSquare } from 'lucide-react';
            ...
            <div className="flex justify-between items-center px-4 h-20">
                ...
                <div className="flex items-center space-x-1.5">
                    ...
                    {isAdminProp ? (
                        <button 
                            onClick={onOpenAdmin}
                            className="active:scale-90 transition-transform shadow-lg focus:outline-none bg-[#141414] px-3 py-1 rounded-md border border-[#141414]/20"
                            aria-label="Dashboard Administrateur"
                        >
                            <span className="text-[10px] font-black uppercase text-[#E4E3E0] tracking-widest">Admin</span>
                        </button>
                    ) : (
