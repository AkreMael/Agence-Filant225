...
const LocationFormScreen: React.FC<LocationFormScreenProps> = ({ itemTitle, onBack }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Log Centralized Request
    const activeUser = databaseService.getActiveUser();
    if (activeUser) {
        await databaseService.logCentralizedRequest(activeUser, 'equipment', {
            item: itemTitle,
    ...
    console.log(`Votre demande pour "${itemTitle}" a été soumise avec succès !`);
